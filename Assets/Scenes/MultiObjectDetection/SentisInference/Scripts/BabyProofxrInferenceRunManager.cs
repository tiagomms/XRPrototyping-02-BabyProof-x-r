...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    ...
    public class BabyProofxrInferenceRunManager : MonoBehaviour
    {
        ...
        [SerializeField] private int m_layersPerFrame = 39;
        [SerializeField] private TextAsset m_labelsAsset;
        public bool IsModelLoaded { get; private set; } = false;

        [Header("UI display references")]
        [SerializeField] private BabyProofxrInferenceUiManager m_uiInference;

        [Header("BabyProofxr filter")]
        [SerializeField] private TextAsset m_dangerousLabelAssets;
        ...
        private IEnumerator Start()
        {
            ...
            m_uiInference.SetLabels(m_labelsAsset, m_dangerousLabelAssets);
